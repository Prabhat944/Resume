...
def create_twocolumn_resume():
    ...
    title_run = title_para.add_run('Mobile Application\nDeveloper')
    ...
    add_sidebar_text(left_cell, 'React, Node.js, Express.js, NestJS, Redux, Zustand, Jotai', Pt(8.5))
    add_sidebar_text(left_cell, 'Languages', Pt(9), RGBColor(200, 220, 255))
    add_sidebar_text(left_cell, 'JavaScript, TypeScript, Kotlin, Swift', Pt(8.5))
    ...
    add_sidebar_text(left_cell, 'Firebase, AWS, Docker, Git, Xcode, Android Studio', Pt(8.5))
    ...
    add_sidebar_bullet(left_cell, 'Achieved 50% faster app launch times through performance optimization', Pt(8.5))
    add_sidebar_bullet(left_cell, 'Reduced crash rate by 40%', Pt(8.5))
    ...
    summary_text = 'Mobile Application Developer with 3+ years of experience building high-performance iOS and Android applications using React Native, Kotlin, and Swift. Strong in native integrations, performance tuning, and end-to-end app delivery, with a consistent focus on scalability, user experience, and clean, maintainable code.'
    ...
    exp1_line_run = exp1_line.add_run('Software Engineer - Mobile App Development  |  Aug 2025 - Present  |  Gurugram, Haryana')
    ...
    add_compact_bullet(right_cell, 'Implemented performance optimization strategies including lazy loading, code splitting, and memory leak detection, resulting in 50% faster app launch times')
    add_compact_bullet(right_cell, 'Integrated analytics platforms including **Firebase Analytics**, **CleverTap**, and **Crashlytics** for real-time monitoring, user behavior tracking, and crash reporting')
    ...
    add_compact_bullet(right_cell, 'Developed RESTful APIs using **NestJS** and **Node.js** to support mobile application backend services and data synchronization')
    add_compact_bullet(right_cell, 'Implemented push notification services and real-time data updates for mobile clients using **Firebase Cloud Messaging** and **WebSocket** connections')
    add_compact_bullet(right_cell, 'Optimized API response times and implemented caching strategies with **Redis**, reducing mobile app data loading time by 25%')
    add_compact_bullet(right_cell, 'Designed database schemas in **MongoDB** optimized for mobile app queries, improving data retrieval performance')
    ...
    proj2_title_run = proj2_title.add_run('Image Editor Application (iOS & Android)')
    ...
    proj2_tech_run = proj2_tech.add_run('React Native, Redux, Redux Toolkit, TanStack Query, Camera Integration, Image Processing, Cloud Storage')
    ...
    add_compact_bullet(right_cell, 'Designed real-time image processing pipeline with GPU acceleration and custom rendering engine for iOS and Android platforms')
    add_compact_bullet(right_cell, 'Implemented state synchronization using **Redux Middleware**, **Jotai**, and **RxJS** for reactive data flow and optimal rendering performance')
    
    # Project 3 - Backend Services for Mobile Apps
    proj3_title = right_cell.add_paragraph()
    proj3_title_run = proj3_title.add_run('Backend Services & APIs (Supporting Mobile Applications)')
    ...
    proj3_tech_run = proj3_tech.add_run('Node.js, NestJS, MongoDB, Redis, RESTful APIs, GraphQL, Firebase')
    ...
    add_compact_bullet(right_cell, 'Architected scalable backend APIs using **NestJS** supporting multiple mobile applications with authentication, data synchronization, and real-time updates')
    add_compact_bullet(right_cell, 'Implemented efficient data caching with **Redis** and optimized database queries, reducing mobile app API response times by 30%')
    
    # Save document
    output_file = 'Prabhat_Kumar_Resume_TwoColumn.docx'
