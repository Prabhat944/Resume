...
def create_twocolumn_resume():
    ...
    set_margins(section, 0.3, 0.3, 0.3, 0.3)
    ...
    # Set padding for both cells (in inches)
    set_cell_margins(left_cell, 0.1, 0.1, 0.15, 0.1)
    set_cell_margins(right_cell, 0.1, 0.1, 0.15, 0.1)
    ...
    proj2_title_run = proj2_title.add_run('Image Editor Application (iOS, Android & Web)')
    ...
    proj2_tech_run = proj2_tech.add_run('React Native, React, Next.js, Redux, Redux Toolkit, Camera Integration, Image Processing')
    ...
    add_compact_bullet(right_cell, 'Designed real-time image processing pipeline with GPU acceleration and custom rendering engine for cross-platform workflows')
    add_compact_bullet(right_cell, 'Implemented state synchronization using **Redux Middleware** and **Reselect** for optimal rendering performance')
